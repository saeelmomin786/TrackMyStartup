          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 border border-slate-200">
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-3xl font-bold text-brand-primary">₹299</span>
                  <span className="text-slate-600">/month</span>
                </div>
                <div className="text-sm text-slate-500 mb-6">
                  or <span className="font-semibold text-slate-700">₹2999/year</span> (save 17%)
                </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 border border-slate-200 relative">
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-3xl font-bold text-brand-primary">₹499</span>
                  <span className="text-slate-600">/month</span>
                </div>
                <div className="text-sm text-slate-500 mb-2">
                  per <b>invested</b> startup
                </div>
                <div className="text-sm text-slate-500 mb-6">
                  or <span className="font-semibold text-slate-700">₹4999/year</span> per <b>invested</b> startup (save 33%)
                </div>
                <ul className="text-left space-y-2 text-slate-600 mb-6">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 border border-slate-200">
              <div className="text-center">
                ...
                <div className="mb-4">
                  <span className="text-3xl font-bold text-brand-primary">₹0</span>
                  <span className="text-slate-600">/month</span>
                </div>
                <div className="text-sm text-slate-500 mb-6">
                  Flat monthly rate
