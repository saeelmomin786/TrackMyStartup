...
export const CompleteRegistrationPage: React.FC<CompleteRegistrationPageProps> = ({
  ...
  const handleLogout = async () => {
    try {
      ...
      // Force a full page reload to clear all App.tsx state and prevent redirect to dashboard
      // This ensures isAuthenticated and currentUser are properly cleared
      window.location.href = '/?page=login';
    } catch (error) {
      console.error('Error during logout:', error);
      // Even if signOut fails, still redirect to login page
      window.location.href = '/?page=login';
    }
  };
