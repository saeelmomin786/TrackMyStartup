...
import { Shield, ChevronDown, ShieldCheck, ClipboardList, Inbox, FileText, Activity, Search, Play, Eye, CheckCircle, BarChart3, Menu, X } from 'lucide-react';
import Button from '../ui/Button';
import LogoTMS from '../public/logoTMS.svg';
import CSIllustration from '../public/CA1.svg';
import Footer from '../Footer';
import SEOHead from '../SEOHead';

const CSServicePage: React.FC = () => {
  ...
  // YouTube video URL for the CS walkthrough section
  const csWalkthroughVideoUrl: string | null = null; // Set to video URL when available
  ...
  const canonicalUrl = `${siteUrl}/services/cs`;

  return (
    <div className="min-h-screen bg-slate-50">
      <SEOHead
        title="For CS - Corporate Secretarial & Compliance Services | TrackMyStartup"
        description="Comprehensive platform for Company Secretaries to manage corporate secretarial services, track compliance, handle regulatory filings, and provide governance advisory."
        ...
        structuredData={{
          ...
          '@type': 'Service',
          serviceType: 'Company Secretary Services Platform',
          provider: {
            '@type': 'Organization',
            name: 'TrackMyStartup',
            url: siteUrl
          ...
          description: 'Platform for Company Secretaries to manage corporate secretarial services, track compliance, handle regulatory filings, and provide governance advisory.'
        }}
      />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="flex-1 text-center lg:text-left">
              <h5 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-700 mb-3 leading-tight" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                Governance and Secretarial Workflows Made Simple
              </h5>
              <p className="text-lg sm:text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                Track My Startup enables Company Secretaries to manage statutory filings, governance tasks, and startup compliance with clarity and efficiency.
              </p>
            ...
            <div className="flex-1 flex items-center justify-center">
              <img src={CSIllustration} alt="Company Secretary Illustration" className="w-full h-auto max-w-lg lg:max-w-full" style={{ maxHeight: '500px', objectFit: 'contain' }} />
            </div>
          </div>
        </div>

        {/* Everything a Company Secretary Needs Section */}
      </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                Everything a Company Secretary Needs
              </h2>
              <p className="text-lg text-white max-w-2xl mx-auto" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                All secretarial and governance operations managed from one unified platform.
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
              {/* Item 1: Statutory Compliance Oversight */}
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Track statutory filings, due dates, and governance obligations across startups.
                </p>
              </div>

              {/* Item 2: Assignment & Client Management */}
              <div className="flex flex-col items-center text-center group">
                <div className="mb-6 transition-transform duration-300 ease-out group-hover:-translate-y-1.5">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border border-blue-100/50" style={{ backgroundColor: '#D1E7EA' }}>
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Manage multiple startup assignments and service engagements from one place.
                </p>
              </div>

              {/* Item 3: Request & Approval Handling */}
              <div className="flex flex-col items-center text-center group">
                <div className="mb-6 transition-transform duration-300 ease-out group-hover:-translate-y-1.5">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border border-blue-100/50" style={{ backgroundColor: '#D1E7EA' }}>
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Receive, review, accept, or reject secretarial requests raised by startups.
                </p>
              </div>

              {/* Item 4: Governance & Board Records */}
              <div className="flex flex-col items-center text-center group">
                <div className="mb-6 transition-transform duration-300 ease-out group-hover:-translate-y-1.5">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border border-blue-100/50" style={{ backgroundColor: '#D1E7EA' }}>
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Maintain records for board meetings, resolutions, filings, and statutory registers.
                </p>
              </div>

              {/* Item 5: Compliance Status Monitoring */}
              <div className="flex flex-col items-center text-center group">
                <div className="mb-6 transition-transform duration-300 ease-out group-hover:-translate-y-1.5">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border border-blue-100/50" style={{ backgroundColor: '#D1E7EA' }}>
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Track compliance status in real time — pending, filed, approved, or overdue.
                </p>
              </div>

              {/* Item 6: Multi-Startup Search & Filters */}
              <div className="flex flex-col items-center text-center group">
                <div className="mb-6 transition-transform duration-300 ease-out group-hover:-translate-y-1.5">
                  <div className="w-20 h-20 rounded-full flex items-center justify-center border border-blue-100/50" style={{ backgroundColor: '#D1E7EA' }}>
                ...
                <p className="text-sm text-slate-300 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  Quickly search startups and filter by compliance status or filing type.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* See How Company Secretaries Use Track My Startup Section */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                <h2 className="text-3xl sm:text-4xl font-bold mb-4" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', color: '#1E293B' }}>
                  See How Company Secretaries Use Track My Startup
                </h2>
                <p className="text-lg text-slate-600 mb-4 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  A walkthrough of how Company Secretaries manage filings, governance records, and statutory compliance from one dashboard.
                </p>
              </div>

              {/* Right Column: Video Container */}
              <div className="flex-1 w-full lg:max-w-2xl">
                {csWalkthroughVideoUrl ? (
                    ...
                    <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                      <div className="absolute top-0 left-0 w-full h-full">
                        <iframe
                          ...
                          src={csWalkthroughVideoUrl}
                          title="Track My Startup Company Secretary Dashboard Walkthrough"
                          frameBorder="0"
                    ...
                    <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-slate-700 mb-2" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                          Company Secretary dashboard walkthrough coming soon
                        </h3>
                        <p className="text-sm text-slate-500 max-w-sm" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                          We're preparing a guided demo to showcase the Company Secretary experience.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* A Clear Secretarial Workflow Timeline Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-medium text-slate-800 mb-16 sm:mb-20 text-center" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
              A Clear Secretarial Workflow, From Filing to Governance Control
            </h2>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-12">
                  ...
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                        Review statutory requirements, upcoming filings, and startup requests.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Stage 02: File & Execute - Visual Anchor */}
                <div 
                  className="relative group"
                ...
                >
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    >
                      <h3 className="text-xl font-medium text-slate-800 mb-2" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                        Stage 02 – File & Execute
                      </h3>
                      <p className="text-sm text-slate-600 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                        Manage filings, update registers, record resolutions, and complete governance actions.
                      </p>
                    </div>
                  </div>
                </div>

                {/* Stage 03: Monitor & Govern */}
                <div 
                  className="relative group"
                ...
                >
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                        Track ongoing compliance, manage overdue items, and support long-term governance needs.
                      </p>
                    </div>
                  </div>
                </div>
